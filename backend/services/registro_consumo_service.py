...
def registrar_consumo(registro_consumo):
    query = """INSERT INTO registro_consumo (registro_consumo_id,id_maquina, id_insumo, fecha, cantidad_usada) 
               VALUES (%s,%s, %s, %s, %s)"""
    values = (registro_consumo.id,registro_consumo.id_maquina, registro_consumo.id_insumo, registro_consumo.fecha, registro_consumo.cantidad_usada)
...
def modificar_registro_consumo(rergistro_consumo, nuevos_datos_registro_consumo):
