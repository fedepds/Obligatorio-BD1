...
CREATE TABLE IF NOT EXISTS mantenimientos (
    ...
    FOREIGN KEY (id_tecnico) REFERENCES tecnicos(id) ON DELETE RESTRICT
);
...
INSERT INTO clientes (rut, nombre, direccion, fecha_nacimiento, telefono, correo) VALUES
(10000001, 'Empresa Uno S.A.', 'Av. Principal 123, Montevideo', '1990-01-15', '091234567', 'contacto@empresau1.com'),
(10000002, 'Edificio Centenario', 'Calle Falsa 456, Canelones', '1985-03-22', '092234455', 'edificio@centenario.com'),
(10000003, 'Hospital del Sur', 'Ruta 8 km 25, Maldonado', '1992-07-10', '095664477', 'info@hospitalsur.com'),
(10000004, 'Instituto Santa Ana', 'Bulevar Artigas 999, Salto', '1988-11-05', '098112233', 'santaana@instituto.com'),
(10000005, 'Colegio Moderno', 'Av. Italia 321, Montevideo', '1995-09-18', '096445566', 'info@colegiomoderno.edu.uy'),
(10000006, 'Residencial Los Pinos', 'Camino Rural 14, Florida', '1987-12-03', '097667788', 'pinos@residencial.com');
